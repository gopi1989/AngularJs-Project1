...
module.exports = function (config) {
  ...
  config.set({
    ...
    files: [
      ...
      'bower_components/ng-marviluz/ng-marviluz.js',
      ...
      'bower_components/wepa-core/dist/wepa.js',
      'bower_components/ng-file-upload/ng-file-upload.js',
      'bower_components/angular-mocks/angular-mocks.js',
      // endbower
      'bower_components/wepa-angular-core/dist/wepa-angular-core/wepa.js',
    ...
    coverageReporter: {
      type: 'html', // if value is HTML coverage generate html report
      dir: 'coverage/',
      file: ''
    }
